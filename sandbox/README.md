...
# go to sandbox. Save index at pong/pong_tiers_32.p.
    ...
    # input_path, output_path, final_size, throw_frac
    python -m subset_selection.make_all_subset_batches tiers ./domains/pong/pong_data/ppo_1e5_32.p ./domains/pong/pong_data/ppo_1e5_tiers.p 10000 0.05
